...
Metadata-driven orchestration — no hard-coded table logic

Incremental loading and backfilling — avoids scanning full tables

Watermark tracking per table — ensures CDC accuracy

Clean output management — removes empty loads to reduce clutter

Post-run alerting — sends operational visibility to outlook.
